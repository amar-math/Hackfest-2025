const quizData = {
    phishing: {
        tutorial: "Phishing is a type of cyber attack in which attackers deceive individuals into providing sensitive information...",
        questions: [
            { question: "What is Phishing?", options: ["A type of malware", "A fake website", "An attempt to trick you into giving personal info", "A strong encryption method"], correct: 2 },
            { question: "Which of the following is an example of Phishing?", options: ["An email asking for personal information", "A secured login page", "A trusted website", "A firewall protection"], correct: 0 }
        ]
    },
    malware: {
        tutorial: "Malware is software designed to disrupt, damage, or gain unauthorized access to a computer system.",
        questions: [
            { question: "What is Malware?", options: ["Harmless software", "A type of cyber attack", "Software designed to harm or exploit any device", "Firewall"], correct: 2 },
            { question: "Which of these is an example of Malware?", options: ["Antivirus", "Spyware", "Cloud storage", "Firewall"], correct: 1 }
        ]
    },
...
if (document.getElementById('topic-name')) {
    document.getElementById('topic-name').textContent = topic.charAt(0).toUpperCase() + topic.slice(1);
    document.getElementById('tutorial-content').textContent = quizData[topic].tutorial;
}

if (document.getElementById('quiz-topic-name')) {
    document.getElementById('quiz-topic-name').textContent = topic.charAt(0).toUpperCase() + topic.slice(1);
}
